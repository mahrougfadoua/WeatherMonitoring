...
import 'package:weathermonitoringapp/Screens/Admin/Widgets/AD_header.dart';
import 'package:weathermonitoringapp/Screens/Login_Screen.dart';
import 'package:sidebarx/sidebarx.dart';
import 'package:weathermonitoringapp/app_palette.dart';


class ADAppDrawer extends StatefulWidget {
  const ADAppDrawer({super.key});

  @override
  State<ADAppDrawer> createState() => _ADAppDrawerState();
}

class _ADAppDrawerState extends State<ADAppDrawer> {
    ...
    try {
      return SidebarX(
        ...
        headerBuilder: (context, extended) {
          return SafeArea(child: extended ? ADHeader() : Container()
        ...
        items: [
          SidebarXItem(
            ...
            onTap: () {
              debugPrint('Home');
              Navigator.of(context).pushReplacementNamed(ADMainScreen.screenRoute);
            },
          ),
          SidebarXItem(
              icon: Icons.settings,
              label: 'Settings',
              onTap: () {
                Navigator.of(context).pushNamed(ADSettingScreen.screenRoute);
              }),
          SidebarXItem(
            onTap: () {
              Navigator.of(context).pushNamed(ADManageUserScreen.screenRoute);
            },
            icon: Icons.people,
            label: 'Users',
          ),
