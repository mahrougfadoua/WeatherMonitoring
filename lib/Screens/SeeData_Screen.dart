...
import 'package:weathermonitoringapp/Widgets/AppDrawer.dart';
import 'package:weathermonitoringapp/app_data.dart';

class SeeDataScreen extends StatefulWidget {
  const SeeDataScreen({Key? key}) : super(key: key);

  static const screenRoute = '/SeeData_Screen';

  @override
  State<SeeDataScreen> createState() => _SeeDataScreenState();
}

class _SeeDataScreenState extends State<SeeDataScreen> {
